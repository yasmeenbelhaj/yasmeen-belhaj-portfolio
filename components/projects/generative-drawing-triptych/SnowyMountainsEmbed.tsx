...
import snowyMountainsSketch from "../../../lib/p5/snowyMountainsSketch";

const SKETCH_WIDTH = 700;
const SKETCH_HEIGHT = 1024;
const MAX_VIEWPORT_HEIGHT = 0.78;

export default function SnowyMountainsEmbed() {
  ...
  useEffect(() => {
    ...
    async function initSketch() {
      ...
      sketchRef.current = new P5(snowyMountainsSketch, mountRef.current);
    }
